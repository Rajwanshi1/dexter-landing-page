  ...
  const steps = [
    {
      title: "Scan",
      description:
        "Monitors lending pools, tracking APR, incentives, and volatility across protocols.",
      icon: "custom",
    },
    {
      title: "Score",
      description:
        "Calculates projected net yield post-fees, surfacing only capital-efficient, high-reward paths.",
      icon: "score",
    },
    {
      title: "Execute",
      description:
        "Atomically moves funds between strategies via smart account, fully non-custodial.",
      icon: "execute",
    },
  ];
      ...
      <div className="container-dexter">
        ...
        <ScrollReveal className="text-center mb-12 lg:mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-black/15 border border-black/20 rounded-full mb-6 lg:mb-8 page-bubble">
            ...
            <span className="text-[10px] sm:text-[16px] text-black font-mono font-medium uppercase tracking-wide">
              How It Works
            </span>
          </div>

          <h2
            className="text-[26px] sm:text-headline font-display mb-6 lg:mb-8"
            style={{ color: "#000000" }}
          >
